...
@ConditionalOnProperty(name = "payment.processor", havingValue = "nolock")
public class NoLockPaymentProcessor implements PaymentProcessor {
    ...
    public void process(Long reservationId, PaymentResult paymentResult) {
        ...
        // 락 없이 체크만 — validate()와 process() 사이 경쟁 조건이 그대로 노출됨
