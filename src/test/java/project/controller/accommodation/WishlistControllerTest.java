...
import project.wishlist.adapter.in.web.WishlistController;
...
class WishlistControllerTest extends RestDocsTestSupport {
    ...
    void createWishlist() throws Exception {
        ...
        WishlistCreateResponse responseDto = new WishlistCreateResponse(1L, requestDto.wishlistName());

        given(wishlistService.createWishlist(any(WishlistCreateRequest.class), anyLong())).willReturn(responseDto);
    ...
    void addAccommodation() throws Exception {
        //given
        AddAccToWishlistRequest requestDto = new AddAccToWishlistRequest(1L);
    ...
    void getAccommodationsFromWishlist() throws Exception {
        //given
        List<WishlistDetailResponse> response = List.of(
                new WishlistDetailResponse(1L, "wishlist-1", "호텔A", "호텔A-설명", 35.3, 42.4, 4.5,
                                           List.of("https://example.com/a.jpg", "https://example.com/b.jpg"), "호텔A-메모"),
                new WishlistDetailResponse(2L, "wishlist-2", "호텔B", "호텔B-설명", 25.3, 47.8, 4.8,
    ...
    void getAllWishlists() throws Exception {
        //given
        List<WishlistsResponse> response = List.of(
                new WishlistsResponse(1L, "my-wishlist-1", "https://example.com/a.jpg", 3),
                new WishlistsResponse(2L, "my-wishlist-2", "https://example.com/b.jpg", 5)
        );
