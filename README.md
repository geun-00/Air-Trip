...
<img width="2207" height="1283" alt="Air-Trip (1)" src="https://github.com/user-attachments/assets/3655d34c-585a-4247-843b-232f2960a11f" />
...
|----------|-------------------------------------------|
| 회원       | 회원 상세                                     |
| 숙소       | 숙소 상세, 숙소 가격, 숙소 이미지, 숙소 편의시설(다대다 중간 테이블) |
| 채팅방      | 채팅 참여자                                    |
| 위시리스트    | 위시리스트 숙소(다대다 중간 테이블)                      |
| 채팅 메시지   | x                                         |
| 후기       | x                                         |
| 예약       | x                                         |
| 결제       | x                                         |
...
> JPA 엔티티 설계시 같은 애그리거트에 속하는 엔티티는 객체 직접 참조로 연관관계를 맺고, 다른 애그리거트에 속하는 엔티티는 PK(ID) 간접 참조로만 연결하도록 설계했습니다.
